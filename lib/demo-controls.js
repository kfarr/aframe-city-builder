...
/***/ function(module, exports, __webpack_require__) {
	...
	AFRAME.registerComponent('demo-controls', {
	  ...
	  /**
	   * Spawns a domino below the controller.
	   * More complicated than it needs to be due to hacky sphere-collider update handling.
	   */
	  onTriggerDown: function () {
	    ...
	    sceneEl.append('a-obj-model')
	           ...
	           .attr('position', thisItemWorldPosition)
						 ...
						 // This throws a bunch of errors for some reason:
						 //  .attr('obj-model', 'obj', '#' + bases[baseId].file + '-obj')
						 //  .attr('obj-model', 'mtl', '#' + bases[baseId].file + '-mtl');
	    ...
	    // Have sphere-collider update its list of elements to intersect
	    // this.el.components['sphere-collider'].update();
	    // otherControllerEl.components['sphere-collider'].update();  // Update other controller as well
		...
		onTrackpadDown: function () {
			...
			// wonky logic to fetch the element representing to the current Vive wand's item
			var controllerEl = d3.select(this.el);
	    var controllerID = controllerEl.attr('id');
			var thisItemID = (controllerID === 'leftController') ? '#leftItem':'#rightItem';
			var thisItemEl = document.querySelector(thisItemID);
