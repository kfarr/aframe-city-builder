	  ...
	  onTriggerDown: function () {
	    ...
	    sceneEl.append('a-obj-model')
	           ...
	           .attr('position', controllerWorldPosition)
						...
						//  .attr('rotation', controllerWorldRotation._x + ' ' + controllerWorldRotation._y + ' ' + controllerWorldRotation._z)
  					//  .attr('quaternion', controllerWorldQuaternion)
						 	          //  .attr('class', 'throwable')
						 						//  .attr('dynamic-body', '') // make it physic-like

						 console.log('rotation: ' + controllerWorldRotation._x + ' ' + controllerWorldRotation._y + ' ' + controllerWorldRotation._z);
						 console.log('position: ' + controllerWorldPosition);
